...
import 'schema/game_status_record.dart';
...
export 'schema/game_status_record.dart';
...
/// Functions to query GameStatusRecords (as a Stream and as a Future).
Future<int> queryGameStatusRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      GameStatusRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<GameStatusRecord>> queryGameStatusRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      GameStatusRecord.collection,
      GameStatusRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<GameStatusRecord>> queryGameStatusRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
